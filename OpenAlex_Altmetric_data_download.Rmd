...
This script uses OpenAlex and Altmetric databases, and ORCID API to download data on professors in our sample.
...
First, get all the coauthor yearly OA statistics and a full list of names:
```{r}
...
all_govt_positions_match$profile_id[which(is.na(all_govt_positions_match$profile_id))] <- "https://www.narcis.nl/person/RecordID/PRS1238628"
```
