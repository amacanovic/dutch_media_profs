...
average_news <- field_comparisons_plot %>%
  ...
  scale_y_continuous(limits = c(0, 104), breaks = seq(0, 104, by = 26))+
...
news_gender_plot <- predictions_plot %>%
  ...
  scale_y_continuous(limits = c(0, 6.4), breaks = seq(0, 6, by = 1.5))+
  stat_pvalue_manual(
    p_values,
    y.position = c(5.2, 5.2, 6.4, 5.5),
    label.size = 3,
    tip.length = 0.003,
    label = "{stars}",
    remove.bracket = FALSE,
